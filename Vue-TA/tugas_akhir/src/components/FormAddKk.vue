          ...
          <div class="form-group row">
            ...
            <div class="col-3">
              ...
              <div class="d-flex justify-content-end">
                <button v-show="Submit" type="submit" class="btn btn-info mt-5">
                  {{ buttonValue }}
                </button>
                <button
                  @click="cancelBtn"
          ...
          .catch((e) => {
            ...
            if (e.response.status == 500) {
              Swal.fire({
                position: "center",
                icon: "warning",
                title: "Nomor KK Sudah digunakan",
                showConfirmButton: true,
                timer: 1500,
              });
            }
